<template>
  <div class="orderFilling">
    ...
    <!-- 提交订单小功能 -->
    <OrderFillingSmallFunction v-for="(item,index) in orderFilling" :orderFilling="item"
                               class="orderFillingSmallFunction"
                               :key="index"/>
    <!-- 底部购买按钮 -->
...
<script>
  ...
  /* 收货地址 */
  import OrderFillingAddress from "../components/orderFilling/orderFillingAddress.vue"
  /* 提交订单的商品详情 */
...
<style scoped>
  ...
  .orderFillingSmallFunction:nth-of-type(7) {
    margin-top: 20px;
  }
</style>
