...
<!--  医生介绍-->
    <div class="diagonseIntroduceWrap">
      <div class="diagonseIntroduce" v-for="item in diagonseIntroduce">
        <div class="IntroduceImg">
          <img :src="item.doctorImg" alt="">
        </div>
        <div class="IntroduceContent">
          <!-- 医生姓名-->
          <p class="doctorName">{{item.doctorIntroduce.doctorName}}<span>{{item.doctorIntroduce.doctorJob}}</span></p>
          <!--医院等级 -->
          ...
          <div class="discount">
            ...
            <div class="dis">
              ...
              <span>仅剩{{item.price.surplus}}个名额</span>
            </div>
          </div>
          <!--新人专享-->
          <div class="news">
...
<style scoped>
  ...
  .discount .dollar,.discount .price{
    font-size: 22px;
    color: #f76260;
  }
  .discount del{
